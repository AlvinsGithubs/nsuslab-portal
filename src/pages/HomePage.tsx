...
const HomePage: React.FC = () => {
  ...
  const Section:React.FC<{id: string, title: string, subtitle: string, children: React.ReactNode, className?: string, link?: string, linkText?: string}> = 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {link && linkText && (
            <div className="mt-12 text-center">
              <a href={link} onClick={(e) => navigate(e, link)} className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-nsus-blue hover:bg-blue-700 transition-transform hover:scale-105">
                {linkText}
    ...
    <div>
      ...
      >
        <div className="relative rounded-lg overflow-hidden shadow-xl">
            <img src="https://picsum.photos/seed/culture/1200/500" alt="Company Culture" className="w-full h-[500px] object-cover" />
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                <button className="bg-white/20 backdrop-blur-sm rounded-full p-6 text-white hover:bg-white/30 transition-colors" onClick={() => window.location.hash = '#/culture'}>
      ...
      <div className="bg-nsus-blue">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-blue-200">{t('home_cta_start_your_journey')}</span>
          </h2>
          <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            <div className="inline-flex rounded-md shadow">
              <a href="#/careers" onClick={(e) => navigate(e, '#/careers')} className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-nsus-blue bg-white hover:bg-nsus-light-blue">
