...
const InfoRow: React.FC<{ label: string; children: React.ReactNode; className?: string }> = ({ label, children, className }) => (
    <div className={`flex flex-col md:flex-row items-start ${className}`}>
        <dt className="w-full md:w-28 flex-shrink-0 font-bold text-nsus-gray-700 uppercase">{label}</dt>
  ...
  return (
    <div className="bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-1">
                  <h2 className="text-3xl font-bold text-nsus-gray-900">엔서스랩코리아</h2>
              </div>
        ...
        <section>
          <h2 className="text-3xl font-bold text-nsus-gray-900 mb-4">NSUSGROUP</h2>
