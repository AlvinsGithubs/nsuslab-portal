...
const WorkAtNSUSLABItem: React.FC<{
  number: string;
  title: string;
  description: string;
  imageUrl: string;
...
const BenefitItem: React.FC<{ title: string; description: string }> = ({
  title,
  description,
}) => (
  <div>
...
const BenefitCategory: React.FC<{
  ...
  <div className="grid md:grid-cols-4 gap-8 py-10 border-b border-nsus-gray-200">
    <div className="md:col-span-1">
      <h3 className="text-2xl font-bold text-nsus-gray-900 sticky top-24">
        {title}
      </h3>
    </div>
    <div className="md:col-span-3 space-y-8">{children}</div>
  </div>
);

const BenefitsPage: React.FC = () => {
  const [benefits, setBenefits] = useState<Benefit[]>([]);
  const [categorizedBenefits, setCategorizedBenefits] = useState<
    ...
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left max-w-xl">
            ...
            <p className="mt-4 text-lg text-nsus-gray-700">
              엔서스랩은 수평적인 문화에서 도전하며 성장할 수 있도록 최고의
              보상과 근무 환경을 제공합니다.
            </p>
          </div>
          <div className="mt-12 w-full h-[500px] rounded-xl bg-gray-200 overflow-hidden">
            <img
              src="https://picsum.photos/seed/new-benefits-hero/1280/500"
              alt="NSUSLAB Team"
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-nsus-gray-900 mb-16">
            Work at NSUSLAB
          </h2>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-nsus-gray-900 mb-10">
            What we offer
          </h2>
          <div>
