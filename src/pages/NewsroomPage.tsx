...
const PressReleaseView: React.FC<{ articles: NewsArticle[] }> = ({
  articles,
}) => {
  ...
  return (
    <div>
      <h1 className="text-5xl font-bold text-nsus-gray-900 text-center mb-16">
        Press Release
      </h1>
      {featuredArticle && (
          ...
          <div className="flex flex-col justify-center space-y-4">
            {sideArticles.map((article) => (
              <a
                ...
                key={article.id}
                className="group flex items-center gap-4 p-2 rounded-lg hover:bg-nsus-gray-100"
              >
