...
const RuleItem: React.FC<{ title: string; description: string }> = ({
  title,
  description,
}) => (
    ...
    <div className="bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-nsus-gray-900">
              NSUS는 iGaming Contents를 통해
              <br />
              유저와 회사를 넘어, 유저와 유저를 연결함으로써
              <br />
              세상을 연결하고자 합니다.
            </p>
            <p className="mt-4 text-lg text-nsus-gray-900">
              즐거움의 가치를 극대화해 나가는 것이
              <br />
              우리가 지향하는 궁극적인 목표임과 동시에
              <br />
              존재의 이유입니다.
            </p>
          </div>
          <div className="w-full h-80 bg-gray-200 rounded-xl overflow-hidden shadow-md">
            <img
              src="https://picsum.photos/seed/mission-culture/800/600"
              alt="Mission"
      ...
      <Section title="Vision">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-nsus-gray-900">
              우리의 궁극적인 목표를 달성하기 위해서는
              <br />
              반드시 글로벌 iGaming 업계를 선도하는
              <br />
              업체가 되어야 합니다.
            </p>
            <p className="mt-4 text-lg text-nsus-gray-900">
          ...
          <div className="w-full h-80 bg-gray-200 rounded-xl overflow-hidden shadow-md">
            <img
              src="https://picsum.photos/seed/vision-culture/800/600"
              alt="Vision"
              className="w-full h-full object-cover"
            />
          </div>
      ...
      <div className="bg-nsus-gray-100">
        <section className="py-20 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl font-bold text-nsus-gray-900 mb-20">
            ...
            <div className="space-y-20">
              {/* Working Way 1 */}
              <div>
                <h3 className="text-2xl font-bold text-nsus-gray-900">
                  Work Transparently and Proactively
                </h3>
                <p className="mt-2 text-nsus-gray-900">
                  일의 모든 과정에서 투명성을 유지하고, 주도적으로 문제를
                  해결합니다.
                </p>
                <p className="mt-4 text-nsus-gray-900 max-w-3xl">
                  엔서스랩은 공개된 채널을 통해 정보를 공유하고, 스스로 문제를
                  정의하고 해결 방법을 제시하는 방식으로 일합니다.
                </p>
              ...
              <div>
                ...
                <p className="mt-2 text-nsus-gray-900">
                  우리는 신뢰를 바탕으로, 솔직하고 두려움 없이 소통합니다.
                </p>
                <p className="mt-4 text-nsus-gray-900 max-w-3xl">
                  솔직한 대화와 피드백이 조직의 성장을 이끄는 힘이라고 믿으며,
                  소통을 '신뢰 구축과 성장의 과정'이라고 생각합니다.
                </p>
                <div className="mt-8 grid sm:grid-cols-2 gap-8">
                  <WorkingWayCard
              ...
              <div>
                ...
                <p className="mt-2 text-nsus-gray-900">
                  문제를 명확히 정의하고, 다양한 시각에서 해결책을 도출한 후,
                  최적의 솔루션을 제시하고 실행합니다.
                </p>
                <p className="mt-4 text-nsus-gray-900 max-w-3xl">
                  문제란 모호할수록 조직적 해결이 어렵습니다. 진짜 문제가
                  무엇인지 정의하는 것이 해결의 첫걸음입니다.
                </p>
