    ...
    <div className="bg-nsus-gray-100 py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 text-center">
          <p className="text-base font-semibold text-nsus-blue">
            {job.department}
          </p>
          <h1 className="mt-2 text-4xl font-bold tracking-tight text-nsus-gray-900 sm:text-5xl">
            {job.title}
          </h1>
        </div>
        ...
        <div className="mt-16 lg:grid lg:grid-cols-3 lg:gap-8">
          ...
          <aside className="mt-8 lg:mt-0">
            <div className="sticky top-24 bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold text-nsus-gray-900">
                Job Overview
              </h3>
              ...
              <p className="text-center mt-4 text-sm text-nsus-gray-500">
