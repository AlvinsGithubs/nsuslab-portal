        ...
        onUpdate: () => {
          if (ref.current) {
            ref.current.innerText = Number(
              gsap.getProperty(ref.current, "innerText")
            ).toLocaleString();
          }
        },
      });
  ...
  return (
    <div className="bg-[#0b0f1a] text-white">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <motion.path
              ...
              transition={{
                pathLength: { duration: 4, ease: "circOut" },
      ...
      <section
        ...
        className="bg-white text-nsus-gray-900 py-20 md:py-32"
      >
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <motion.div
              className="space-y-5 text-lg text-nsus-gray-700 leading-relaxed"
              variants={fadeInVariants}
            >
              <p>
                NSUS Group은 현재 북미, 유럽, 아시아 등 다양한 지역에 700명
                이상의 임직원들이 일하고 있는 다국적 기업으로, iGaming 업계의
                유니콘 입니다.
              </p>
              <p>
                NSUSLAB(엔서스랩)은 이러한 NSUS Group의 개발 스튜디오로서 그룹의
                핵심적인 역할을 하고 있습니다.
              </p>
              <p>
                폭발적 성장에 따른 안정적인 수익과 건실한 재무상태를 바탕으로
                지속적인 인재 영입과 개발 환경 개선에 많은 투자를 하고 있으며,
                성과와 나눔의 복지 확장에도 힘쓰고 있습니다.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <div className="space-y-5 text-lg text-nsus-gray-700 leading-relaxed">
              <p>
                외부 투자에 의지하고 성공에 대한 막연한 희망으로 프로젝트를
                진행하는 대부분의 게임 개발사와는 달리, 저희 NSUSLAB은 성공한
                제품과 사업에 의한 안정적 매출을 기반으로 보다 큰 성공을 이루기
                위해 달리고 있습니다.
              </p>
              <p>
                또한 투자자의 외압이 없는 독자적이며 신속한 의사결정 구조를
                가지고 있습니다. 급변하는 시장에서 이와 같은 효율과 자율성은 큰
                경쟁력이며, 투자자가 아닌 함께 고생한 구성원들에게 노력의 결실이
                보다 많이 돌아갈 수 있는 환경입니다.
              </p>
              <p>
                우리는 단지 꿈만 꾸는 것이 아닌, 좋은 현실을 더 좋게 만들고자
                합니다. 안정적인 개발 환경에서 세계 시장을 제패하기 위해 도전적
                성장과 경험을 함께 할 좋은 인재들을 적극 영입하고 있습니다.
              </p>
            </div>
          </motion.div>
        </div>
