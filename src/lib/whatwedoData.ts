...
export const ggvegasData: BentoGridItem[] = [
  ...
  },
  {
    ...
    description:
      "다른 곳에서는 찾아볼 수 없는 독점 타이틀과 끊임없이 쏟아지는 신작들—오직 GGVegas에서만.",
    isComingSoon: true,
    mediaType: "image",
  ...
  },
  {
    ...
    description: "GGVegas가 멈추지 않는 액션을 당신의 손끝으로 전해드립니다.",
    isComingSoon: true,
    mediaType: "image",
  ...
  },
  {
    ...
    className: "md:col-span-1 md:me-0",
    title: "New Originals",
    description: "새로운 게임들이 계속 출시됩니다. 다음에 올 신작들을 확인해 보세요.",
    isComingSoon: true,
    mediaType: "image",
  ...
  },
  {
    ...
    className: "row-span-1 md:col-span-1 md:row-span-2",
    title: "GGVegas App",
    description: "내 손 안의 베가스. 스마트하게 스핀하고 기분 좋게 승리하세요.",
    isComingSoon: true,
    mediaType: "image",
