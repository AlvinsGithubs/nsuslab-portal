...
export const featureData: Feature[] = [
  {
    ...
    heading: "질문으로 시작된 여정",
    description:
      "우리는 포커와 그 문화를 사랑했습니다. 하지만 우리가 사랑했던 포커 게임은 점점 본질을 잃어가고 있었습니다. 즐거움 대신 승패만이, 새로운 플레이어 대신 소수의 '꾼'들만이 남은 시장. 더 이상 게임은 즐겁지 않았고, 우리는 스스로에게 질문을 던졌습니다.",
    listItems:
  ...
  },
  {
    ...
    listItems:
      "\n우리는 증명했습니다. \n사람과 재미라는 단순한 가치가 가장 강력한 혁신이 될 수 있다는 것을.",
    bgColor: "#000000",
    primaryTextColor: "#ffffff",
    secondaryTextColor: "#ffffff",
  },
  {
    ...
    description:
      "온라인 포커 시장을 근본부터 바꾸었던 우리의 성공 방정식은 더 큰 가능성을 향한 질문으로 이어집니다. 'iGaming을 통해 세상을 더 즐겁게 만들 수는 없을까?'\nFIFA가 축구를 통해 전 세계인을 하나로 묶는 것처럼, 우리는 iGaming을 통해 국경과 언어를 넘어선 연결과 즐거움을 만들고자 합니다.\n\n우리의 미션은 명확합니다.",
